...
def ewmac_calc_vol(price, Lfast, Lslow=None, vol_days=35, resample_bd: bool = False):
    """
    ...
    :param resample_bd: If True, resample price to business days before calculation
